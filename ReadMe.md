...
It provides more options for strict and sensitive then route has and can put it to a varaible.
2. How would you explain form validation to someone who has never programmed before?
It makes is so you cant submit things that the website does not want.
3. In 1-2 sentences, define end to end testing.
a way of testing from opening the site to completeing a task. i.e. making an order or making a appt.
